...
(function (Gender) {
    ...
    Gender[Gender["PreferNotToSay"] = 2] = "PreferNotToSay";
})(Gender || (Gender = {}));
// Student level option
var StudentLevel;
(function (StudentLevel) {
    StudentLevel[StudentLevel["hundred"] = 100] = "hundred";
    StudentLevel[StudentLevel["twoHundred"] = 200] = "twoHundred";
    StudentLevel[StudentLevel["threeHundred"] = 300] = "threeHundred";
    StudentLevel[StudentLevel["fourHundred"] = 400] = "fourHundred";
    StudentLevel[StudentLevel["Graduate"] = 500] = "Graduate";
})(StudentLevel || (StudentLevel = {}));
// Name, Relationship, Phone
const emergency = ["Tammy", "Single", 986468];
...
// Add a student
const addStudent = (firstName, lastName, age, gender, level, address, courses, emergencyContact, isActive, cgpa) => {
...
const findStudentByLastname = (lastName) => {
...
const listAllSecondYearStudents = () => {
...
// Register a course 
const registerCourse = (id, courseCode, courseTitle, units) => {
...
// Drop a course
const dropCourse = (id, courseCode) => {
    const student = findStudentById(id);
    if (student) {
...
const findAverageCgpa = () => {
    ...
    let averageCgpa = 0;
    for (let i = 0; i < students.length; i++) {
        averageCgpa += students[i]?.cgpa;
    }
    averageCgpa = averageCgpa / numberOfStudents;
    return averageCgpa;
};
// Sort students by CGPA
const sortStudentsByCgpa = () => {
...
const printStudentProfile = (id) => {
    const student = findStudentById(id);
    console.log(student);
};
// Change student level
const changeStudentLevel = (id, level) => {
    const student = findStudentById(id);
    if (!student)
        return;
    student.level = level;
...
addStudent("Danny", "Brian", 24, Gender.Male, StudentLevel.fourHundred, { street: "12 Pine Rd", city: "Boston", state: "Massachusetts", country: "USA" }, [{ courseCode: "MAT201", courseTitle: "Linear Algebra", units: 3 }], ["Sarah", "Mother", 555014], true, 3.5);
removeStudent(104);
