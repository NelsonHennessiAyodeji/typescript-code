...
class Coder {
    ...
    secondLang; // This "!" is a way of letting the class know that this it does not need to be initialised or identified right away
...
class Peeps {
    ...
    static count = 0; //Static applies directly to the class, not specifially to any instance
    static getCount() {
...
class Bands {
    ...
    set data(value) {
        ...
        if (Array.isArray(value) && value.every(el => typeof el === 'string')) {
            ...
            throw new Error("Parama is not an arrya of strings");
    }
}
